...
def notify_controller_about_task_acquisition_path(task_id: str, src: str | Path, link: str):
    ...
    asyncio.run(controller_api.client.put('task_acquisition_path_notification', data=notification.model_dump_json()))
